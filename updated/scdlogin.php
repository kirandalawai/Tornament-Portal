...
<head>
  <?php
    ...
    $sql1="SELECT username,password FROM teamreg WHERE username='".$un."' && password='".$ps."'";
    $result=mysqli_query($conn,$sql);
    $result1=mysqli_query($conn,$sql1);
    
    if(mysqli_num_rows($result) || mysqli_num_rows($result1)==1){
      session_start();
      $_SESSION['login2']=1;
     echo "<script>alert('you can proceed');";
  echo'window.location="drop.php"</script>';
    }
    else{
     echo "<script>alert('your not user');";
...
<div class="container">
  <div class="login">
    ...
    <form method="post" action="">
      ...
      New user?<a href="reg.php">Register</a>
        </label>
      </p>
