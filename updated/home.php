...
{
  $name =$_COOKIE['name4']=0;
}
else
{
  $name=$_COOKIE['name4']+1;
}


setcookie('name4',$name,time()+36000);
if($name > 1)
{
...
?>
  ...
  <body bgcolor="skyblue">
   <div id="container"><center>
    <h1>CRICKY CRICKET TROPHY</h1>
    <h2> Book your Slot and Enjoy the Game</h2></marquee> </center>

<ul>
   
    <li><a href="cricket.php">Book Team</a></li>
  <li><a href="teamupdate.php">Book Tournament</a></li>
  <li><a href="ajax.php">Matches</a></li>
  <li><a href="tmupdate.php">Tournament List</a></li>
