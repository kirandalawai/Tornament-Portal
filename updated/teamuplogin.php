...
<head>
  ...
  if(isset($_POST['submit']))
  {
    ...
    $un=$_POST['uname'];
    $ps=$_POST['password'];
    $sql="SELECT username,password FROM teamreg WHERE username='".$un."' && password='".$ps."'";
    ...
    else
    {
      ...
      echo'window.location="teamuplogin.php"</script>';
    }
  }
...
New user?<a href="teamupreg.php">Register</a>
</center>
</form>
</div>
